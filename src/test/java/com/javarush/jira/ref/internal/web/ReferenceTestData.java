...
public class ReferenceTestData {
    ...
    public static final MatcherFactory.Matcher<RefDTO> REF_DTO_MATCHER = MatcherFactory.usingIgnoringFieldsComparator(RefDTO.class, "id");
    public static final String TASK_CODE = "task";
    public static final Reference ref = new Reference(1L, RefType.TASK, TASK_CODE, "Task");
    public static final RefDTO REF_DTO = new RefDTO(null, RefType.TASK, TASK_CODE, "Task", null);
